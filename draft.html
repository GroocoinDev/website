...
<body>
        ...
        <div class="contents no-select">
            ...
            <nav class="header--nav">
                ...
                <div class="header--lang">
                    <a class="lang--current" href="#">English</a>
                    <ul class="lang--ul">
    ...
    <section class="section section-main">
        <div class="section-main--title-wrap Aligner-item--top">
            <h1 class="section-main--title center" id="typingEffect" data-typeit-whattotype="1st Pre-Sale starts on Jun 4th">1st Pre-Sale starts on Jun 4th</h1>
        </div>
    ...
    <section class="section-two row">
        <div class="section-two--left d-w-50 m-w-100">
            <h3 class="section-two--label">Connect & Share<br/>Your Billion of Grooming<br/>Knowledge</h3>
            <a class="btn btn--black" id="downloadPaper">White Paper</a>
        </div>
    ...
    <section class="section section-slide">
        ...
        <div class="section-roadmap appear" id="section-roadmap">
            ...
            <ul class="roadmap-ul">
                ...
                <li class="roadmap-li">
                    <h3 class="roadmap-title">3Q</h3>
                    <p class="roadmap-body">Groo Analytics CBT (Clost Beta Test)</p>
                </li>
                <li class="roadmap-li">
                    <h3 class="roadmap-title">4Q</h3>
                    <p class="roadmap-body">Groo Analytics Launch</p>
                </li>
            </ul>
        </div>
    ...
    <section class="section section-joy">
        ...
        <div class="appear">
            <h1 class="title add-mg-b white joy--title">The Joy of Activity</h1>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            /* 메인 상단 타이머 */
            $('#clock').countdown('2018/07/01 12:34:56', function (event) {
